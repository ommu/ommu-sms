 ...
 * --------------------------------------------------------------------------------------
 *
 * This is the model class for table "ommu_recruitment_statistic_total".
 *
 * The followings are the available columns in table 'ommu_recruitment_statistic_total':
 * @property string $statistic_key
 * @property string $total
 * @property integer $flag
 * @property string $note
 */
class RecruitmentStatisticTotal extends CActiveRecord
{
	 ...
	 * @return RecruitmentStatisticTotal the static model class
	 */
	...
	{
		return 'ommu_recruitment_statistic_total';
	}
	...
	public function search()
	{
		...
		if(!isset($_GET['RecruitmentStatisticTotal_sort']))
