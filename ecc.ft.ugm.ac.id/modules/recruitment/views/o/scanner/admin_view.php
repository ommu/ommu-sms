...
<?php $this->widget('application.components.system.FDetailView', array(
	...
	'attributes'=>array(
		...
		array(
			'name'=>'event_logo',
			'value'=>$model->event_logo != '' ? $model->event_logo : '-',
			//'value'=>$model->event_logo != '' ? CHtml::link($model->event_logo, Yii::app()->request->baseUrl.'/public/visit/'.$model->event_logo, array('target' => '_blank')) : '-',
			'type'=>'raw',
		),
		array(
			'name'=>'start_date',
