...
class PhonebookController extends Controller
{
	...
	public function actionIndex() 
	{
		...
		$setting = SmsPhonebook::model()->findByPk(1,array(
		...
		$dataProvider = new CActiveDataProvider('SmsPhonebook', array(
			'criteria'=>$criteria,
			'pagination'=>array(
				'pageSize'=>10,
			),
	...
	public function actionAdd() 
	{
		...
		if(isset($_POST['SmsPhonebook'])) {
			...
			*/
			...
			if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
				if($model->save()) {
					Yii::app()->user->setFlash('success', 'SmsPhonebook success created.');
					//$this->redirect(array('view','id'=>$model->phonebook_id));
					$this->redirect(array('manage'));
				}
			}
		}
	...
	public function actionEdit($id) 
	{
		...
		if(isset($_POST['SmsPhonebook'])) {
			...
			*/
			...
			if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
				if($model->save()) {
					Yii::app()->user->setFlash('success', 'SmsPhonebook success updated.');
					//$this->redirect(array('view','id'=>$model->phonebook_id));
					$this->redirect(array('manage'));
				}
			}
