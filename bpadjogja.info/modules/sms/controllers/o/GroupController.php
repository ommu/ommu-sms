...
class GroupController extends Controller
{
	...
	public function actionIndex() 
	{
		...
		$setting = SmsGroups::model()->findByPk(1,array(
		...
		$dataProvider = new CActiveDataProvider('SmsGroups', array(
			'criteria'=>$criteria,
			'pagination'=>array(
				'pageSize'=>10,
			),
	...
	public function actionAdd() 
	{
		...
		if(isset($_POST['SmsGroups'])) {
			...
			*/
			...
			if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
				if($model->save()) {
					Yii::app()->user->setFlash('success', 'SmsGroups success created.');
	...
	public function actionRunAction() {
		...
		if(count($id) > 0) {
			...
			if($actions == 'publish') {
				SmsGroups::model()->updateAll(array(
					'publish' => 1,
				),$criteria);
				...
				SmsGroups::model()->deleteAll($criteria);
			}
		}
	...
	{
		$model = SmsGroups::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='sms-groups-form') {
