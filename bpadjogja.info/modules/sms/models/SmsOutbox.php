...
class SmsOutbox extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('smslog_id, status, user_id, group_id, reply_id, smsc_source, destination_nomor, destination_message, creation_date, creation_id, updated_date, reply_date, c_timestamp', 'safe', 'on'=>'search'),
		);
	}
