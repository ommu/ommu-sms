...
<?php $this->renderPartial('/o/master_subject/_search',array(
	'model'=>$model,
)); ?>
</div>
<?php //end.Search ?>
...
<div class="grid-form">
<?php $this->renderPartial('/o/master_subject/_option_form',array(
	'model'=>$model,
)); ?>
</div>
<?php //end.Grid Option ?>

<div id="partial-book-master-subjects">
	<?php //begin.Messages ?>
	<div id="ajax-message">
	<?php
