...
<?php $this->renderPartial('/o/master_publisher/_search',array(
	'model'=>$model,
)); ?>
</div>
<?php //end.Search ?>
...
<div class="grid-form">
<?php $this->renderPartial('/o/master_publisher/_option_form',array(
	'model'=>$model,
)); ?>
</div>
<?php //end.Grid Option ?>

<div id="partial-book-master-publishers">
	<?php //begin.Messages ?>
	<div id="ajax-message">
	<?php
	...
	<div class="boxed">
		...
		<?php 
			...
			$this->widget('application.components.system.OGridView', array(
				'id'=>'book-master-publishers-grid',
