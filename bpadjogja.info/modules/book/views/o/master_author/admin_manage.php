...
<?php $this->renderPartial('/o/master_author/_search',array(
	'model'=>$model,
)); ?>
</div>
<?php //end.Search ?>
...
<div class="grid-form">
<?php $this->renderPartial('/o/master_author/_option_form',array(
	'model'=>$model,
)); ?>
</div>
<?php //end.Grid Option ?>

<div id="partial-book-master-authors">
	<?php //begin.Messages ?>
	<div id="ajax-message">
	<?php
