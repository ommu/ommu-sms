...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<ul>
		<li>
			<?php echo $model->getAttributeLabel('request_id'); ?><br/>
			<?php echo $form->textField($model,'request_id',array('size'=>11,'maxlength'=>11)); ?>
		</li>
		...
		<li>
			<?php echo $model->getAttributeLabel('requester_id'); ?><br/>
			<?php echo $form->textField($model,'requester_id',array('size'=>11,'maxlength'=>11)); ?>
		</li>
