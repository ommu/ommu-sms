 ...
 * --------------------------------------------------------------------------------------
 *
 * This is the model class for table "ommu_sms_outbox_group".
 *
 * The followings are the available columns in table 'ommu_sms_outbox_group':
 * @property string $group_id
 * @property string $creation_date
 * @property string $creation_id
 */
class SmsOutboxGroup extends CActiveRecord
{
	 ...
	 * @return SmsOutboxGroup the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('group_id, creation_date, creation_id,
